...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen w-full bg-[#110720] text-white overflow-hidden relative">
      ...
      {!isMobile && (
        <>
          <div
            ...
            style={{ border: `1.5px solid ${hovered === "admin" ? "#a78bfa" : hovered === "guest" ? "#e9d5ff" : "rgba(255,255,255,0.3)"}` }}
          />
          <div
            ref={cursorDotRef}
            className="fixed top-0 left-0 w-1.5 h-1.5 rounded-full pointer-events-none z-[99999]"
            style={{ background: hovered === "admin" ? "#a78bfa" : hovered === "guest" ? "#e9d5ff" : "white" }}
          />
        </>
      )}
      ...
      <div
        ...
        style={{ background: "#110720", opacity: entered ? 1 : 0 }}
      />

      {/* Background */}
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse 80% 50% at 50% 0%, rgba(124,58,237,0.2) 0%, transparent 70%)" }} />
        <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse 60% 40% at 100% 100%, rgba(192,132,252,0.06) 0%, transparent 60%)" }} />
        <div
      ...
      <div className="md:hidden flex flex-col min-h-screen px-5 py-8">
        ...
        >
          <div
            ...
            style={{ background: "linear-gradient(135deg, #7c3aed, #a855f7, #e9d5ff)", boxShadow: "0 8px 30px rgba(124,58,237,0.35)" }}
          >
            HL
          </div>
          <h1 className="text-3xl font-black bg-clip-text text-transparent mb-1" style={{ backgroundImage: "linear-gradient(135deg, #ffffff, #a78bfa, #e9d5ff)" }}>
            Hemanth.dev
          </h1>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              boxShadow: "0 8px 32px rgba(192,132,252,0.08)",
            }}
          >
            <div className="flex items-center gap-4">
              ...
              >
                <svg width="26" height="26" fill="none" stroke="#e9d5ff" viewBox="0 0 24 24">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <svg width="18" height="18" fill="none" stroke="#e9d5ff" viewBox="0 0 24 24">
            ...
            <div className="flex gap-2 mt-4 flex-wrap">
              {["Projects", "Blog", "Resume AI", "Contact"].map((tag) => (
                <span key={tag} className="px-2.5 py-1 rounded-lg text-xs font-mono"
                  style={{ background: "rgba(192,132,252,0.08)", border: "1px solid rgba(192,132,252,0.15)", color: "#e9d5ff" }}>
                  {tag}
                </span>
              ))}
            </div>
      ...
      <div className="hidden md:flex h-screen w-full">
        ...
        <div
          ...
          style={{
            ...
            background: "linear-gradient(135deg, #160a28 0%, #140922 50%, #160a28 100%)",
          }}
          onMouseEnter={() => setHovered("guest")}
          onMouseLeave={() => setHovered(null)}
          onClick={() => handleEnter("guest")}
        >
          <div className="absolute inset-0 pointer-events-none transition-opacity duration-500" style={{ background: "radial-gradient(ellipse at center, rgba(192,132,252,0.08) 0%, transparent 70%)", opacity: hovered === "guest" ? 1 : 0 }} />
          <div className="absolute top-0 left-0 right-0 h-0.5 transition-opacity duration-500" style={{ background: "linear-gradient(90deg, transparent, #e9d5ff, transparent)", opacity: hovered === "guest" ? 1 : 0.2 }} />
          ...
          <div className="relative z-10 flex flex-col items-center text-center px-10 transition-all duration-700"
            ...
            <div className="w-24 h-24 rounded-2xl flex items-center justify-center mb-8 transition-all duration-500"
              style={{
                background: hovered === "guest" ? "rgba(192,132,252,0.12)" : "rgba(255,255,255,0.04)",
                border: `1px solid ${hovered === "guest" ? "rgba(192,132,252,0.4)" : "rgba(255,255,255,0.08)"}`,
                boxShadow: hovered === "guest" ? "0 0 40px rgba(192,132,252,0.15)" : "none",
                transform: hovered === "guest" ? "scale(1.1) translateY(-6px)" : "scale(1)",
              }}>
              <svg width="40" height="40" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: hovered === "guest" ? "#e9d5ff" : "rgba(255,255,255,0.35)" }}>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
            </div>

            <p className="text-xs font-mono tracking-widest uppercase mb-3 transition-colors duration-300"
              style={{ color: hovered === "guest" ? "#e9d5ff" : "rgba(255,255,255,0.25)" }}>{"// Enter as"}</p>

            <h2 className="text-7xl font-black mb-4 tracking-tight bg-clip-text text-transparent transition-all duration-300"
              style={{ backgroundImage: hovered === "guest" ? "linear-gradient(135deg, #ffffff, #e9d5ff)" : "linear-gradient(135deg, rgba(255,255,255,0.4), rgba(255,255,255,0.15))" }}>
              Guest
            </h2>
            ...
            <div className="flex flex-wrap gap-2 justify-center mb-8">
              {["Projects", "Blog", "Resume AI", "Contact"].map((tag) => (
                <span key={tag} className="px-3 py-1 rounded-lg text-xs font-mono transition-all duration-300"
                  style={{ background: hovered === "guest" ? "rgba(192,132,252,0.1)" : "rgba(255,255,255,0.04)", border: `1px solid ${hovered === "guest" ? "rgba(192,132,252,0.3)" : "rgba(255,255,255,0.06)"}`, color: hovered === "guest" ? "#e9d5ff" : "rgba(255,255,255,0.2)" }}>
                  {tag}
                </span>
              ))}
            </div>
            ...
            <div className="flex items-center gap-2 px-6 py-3 rounded-xl transition-all duration-300"
              style={{ background: hovered === "guest" ? "rgba(192,132,252,0.1)" : "rgba(255,255,255,0.04)", border: `1px solid ${hovered === "guest" ? "rgba(192,132,252,0.35)" : "rgba(255,255,255,0.06)"}`, transform: hovered === "guest" ? "translateY(-2px)" : "translateY(0)" }}>
              <span className="text-sm font-semibold transition-colors duration-300" style={{ color: hovered === "guest" ? "#e9d5ff" : "rgba(255,255,255,0.25)" }}>Enter Portfolio</span>
              <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" className="transition-transform duration-300"
                style={{ color: hovered === "guest" ? "#e9d5ff" : "rgba(255,255,255,0.25)", transform: hovered === "guest" ? "translateX(4px)" : "translateX(0)" }}>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </div>
          </div>
          ...
          <div className="absolute bottom-8 transition-opacity duration-300" style={{ opacity: hovered === "guest" ? 1 : 0 }}>
            <div className="flex items-center gap-2 text-xs" style={{ color: "rgba(192,132,252,0.5)" }}>
        ...
        <div className="relative flex items-center justify-center z-10 w-px shrink-0">
          <div className="absolute inset-0 transition-all duration-500"
            style={{ background: hovered === "guest" ? "linear-gradient(to bottom, transparent, rgba(192,132,252,0.3), transparent)" : hovered === "admin" ? "linear-gradient(to bottom, transparent, rgba(124,58,237,0.3), transparent)" : "linear-gradient(to bottom, transparent, rgba(255,255,255,0.08), transparent)" }} />
          <div className="absolute w-12 h-12 rounded-full flex items-center justify-center z-20 transition-all duration-500"
            style={{ background: "linear-gradient(135deg, #7c3aed, #a855f7, #e9d5ff)", boxShadow: "0 0 30px rgba(124,58,237,0.4)", transform: hovered ? "scale(1.15)" : "scale(1)" }}>
        ...
        <div
          ...
          style={{
            ...
            background: "linear-gradient(135deg, #0e051a 0%, #25113e 50%, #0e051a 100%)",
          }}
          onMouseEnter={() => setHovered("admin")}
          onMouseLeave={() => setHovered(null)}
          onClick={() => handleEnter("admin")}
        >
          <div className="absolute inset-0 pointer-events-none transition-opacity duration-500" style={{ background: "radial-gradient(ellipse at center, rgba(124,58,237,0.1) 0%, transparent 70%)", opacity: hovered === "admin" ? 1 : 0 }} />
          <div className="absolute top-0 left-0 right-0 h-0.5 transition-opacity duration-500" style={{ background: "linear-gradient(90deg, transparent, #7c3aed, transparent)", opacity: hovered === "admin" ? 1 : 0.2 }} />

          <div className="relative z-10 flex flex-col items-center text-center px-10 transition-all duration-700"
            style={{ opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(30px)", transitionDelay: "0.15s" }}>
            <div className="w-24 h-24 rounded-2xl flex items-center justify-center mb-8 transition-all duration-500"
              style={{
                background: hovered === "admin" ? "rgba(124,58,237,0.15)" : "rgba(255,255,255,0.04)",
                border: `1px solid ${hovered === "admin" ? "rgba(124,58,237,0.5)" : "rgba(255,255,255,0.08)"}`,
                boxShadow: hovered === "admin" ? "0 0 40px rgba(124,58,237,0.2)" : "none",
            ...
            <div className="flex flex-wrap gap-2 justify-center mb-8">
              {["Dashboard", "Projects", "Blog", "Messages"].map((tag) => (
                <span key={tag} className="px-3 py-1 rounded-lg text-xs font-mono transition-all duration-300"
                  style={{ background: hovered === "admin" ? "rgba(124,58,237,0.12)" : "rgba(255,255,255,0.04)", border: `1px solid ${hovered === "admin" ? "rgba(124,58,237,0.3)" : "rgba(255,255,255,0.06)"}`, color: hovered === "admin" ? "#a78bfa" : "rgba(255,255,255,0.2)" }}>
                  {tag}
                </span>
              ))}
            </div>
            ...
            <div className="flex items-center gap-2 px-6 py-3 rounded-xl transition-all duration-300"
              style={{ background: hovered === "admin" ? "rgba(124,58,237,0.12)" : "rgba(255,255,255,0.04)", border: `1px solid ${hovered === "admin" ? "rgba(124,58,237,0.4)" : "rgba(255,255,255,0.06)"}`, transform: hovered === "admin" ? "translateY(-2px)" : "translateY(0)" }}>
      ...
      <div className="hidden md:flex absolute top-8 left-0 right-0 justify-center z-20 flex-col items-center gap-1 transition-all duration-700"
        ...
        <h1 className="text-xl font-black bg-clip-text text-transparent" style={{ backgroundImage: "linear-gradient(135deg, #ffffff, #a78bfa, #e9d5ff)" }}>Hemanth.dev</h1>
      </div>
